        ...
        <div class="main_container">
                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        <div class="menu_section">
                            <ul class="nav side-menu">
                                ...
                                <li>
                                    <a href="chart3.php"><i class="fa fa-bar-chart-o"></i> <span> Chart 3 </span></a>
                                </li>
                            </ul>
                        </div>
            ...
            <script type="text/javascript">
                ...
                Highcharts.chart('container', {
                    ...
                    title: {
                        text: 'Persentase Nilai Penjualan (WH Sakila) - Berdasarkan Hari'
                    },
                    subtitle: {
                        text: 'Klik di potongan kue untuk melihat detil nilai penjualan setiap kategori berdasarkan hari'
                    },
