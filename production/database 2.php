...
$sql = "SELECT concat('name:',t.namahari) as name, concat('y:', sum(fp.amount)*100/'" . $tot_amount[0] . "') as y, concat('drilldown:', t.namahari) as drilldown
			FROM time t
...
$sql = "SELECT t.namahari namahari, sum(fp.amount) as tot_kat
